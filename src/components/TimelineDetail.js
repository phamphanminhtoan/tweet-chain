                            ...
                            <div className="row">
                                <div className="col-md-7 col-sm-7">
                                    <div className="form-group">
                                        <img src="images/users/avatar.jpg" alt="" className="profile-photo-md" />
...
================================================= */}
                        <div className="post-content">
                            ...
                            <img src="images/post-images/14.jpg" alt="" className="img-responsive post-image" />
                            <div className="post-container">
                                <img src="images/users/avatar.jpg" alt="user" className="profile-photo-md pull-left" />
                                <div className="post-detail">
                                    <div className="user-info">
                                        <h5><a href="timeline.html" className="profile-link">Ngô Hải Yến</a> <span className="following">following</span></h5>
                                    ...
                                    <div className="post-comment">
                                        <img src="images/users/avatar.jpg" alt="" className="profile-photo-sm" />
...
================================================= */}
                        <div className="post-content">
                            ...
                            <img src="images/post-images/15.jpg" alt="" className="img-responsive post-image" />
                            <div className="post-container">
                                <img src="images/users/avatar.jpg" alt="user" className="profile-photo-md pull-left" />
                                <div className="post-detail">
                                    <div className="user-info">
                        ...
                        <div id="sticky-sidebar">
                            ...
                            <div className="feed-item">
                                <div className="live-activity">
                                    <p><a href="/" className="profile-link">Hải Yến</a> Commended on a Photo</p>
                                    <p className="text-muted">5 mins ago</p>
                                </div>
                            </div>
                            <div className="feed-item">
                                <div className="live-activity">
                                    <p><a href="/" className="profile-link">Hải Yến</a> Has posted a photo</p>
                                    <p className="text-muted">an hour ago</p>
                                </div>
                            </div>
                            <div className="feed-item">
                                <div className="live-activity">
                                    <p><a href="/" className="profile-link">Hải Yến</a> Liked her friend's post</p>
                                    <p className="text-muted">4 hours ago</p>
                                </div>
                            </div>
                            <div className="feed-item">
                                <div className="live-activity">
                                    <p><a href="/" className="profile-link">Hải Yến</a> has shared an album</p>
